...
configs = [
    # (tabu_iters, ils_outer, ils_perturb)
    (100_000, 5,  100), (100_000, 10, 100), (100_000, 20, 100),
    (100_000, 10, 200), (100_000, 10, 400),
    (200_000, 5,  100), (200_000, 10, 100), (200_000, 5, 200),
    (500_000, 3,  100), (500_000, 5,  200),
]
print(f"{'tabu_it':>8}{'outer':>6}{'pert':>6}{'mean':>10}{'best':>8}{'worst':>8}{'wall':>8}")
for ti, ou, pe in configs:
    t0 = time.perf_counter()
    cuts, _ = simulate_cim_batch_polished(**base, tabu_iters=ti, ils_outer=ou, ils_perturb=pe)
    dt = time.perf_counter() - t0
    print(f"{ti:>8}{ou:>6}{pe:>6}{cuts.mean():>10.1f}{int(cuts.max()):>8}{int(cuts.min()):>8}{dt:>8.2f}")
