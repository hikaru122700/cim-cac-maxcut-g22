...
configs = [
    (1_000_000, 100), (1_000_000, 150), (1_000_000, 200),
    (2_000_000, 150), (2_000_000, 200),
    (5_000_000, 150),
]
print(f"{'iters':>10}{'tenure':>8}{'mean':>10}{'best':>8}{'worst':>8}{'wall':>8}")
for it, te in configs:
    t0 = time.perf_counter()
    cuts, _ = simulate_cim_batch_polished(**base, tabu_iters=it, tabu_tenure=te)
    dt = time.perf_counter() - t0
    print(f"{it:>10}{te:>8}{cuts.mean():>10.1f}{int(cuts.max()):>8}{int(cuts.min()):>8}{dt:>8.2f}")
