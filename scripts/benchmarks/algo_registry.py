...
# ============================================================
BUDGET_GRIDS = {
    # 末尾を延長して、長い時間予算(--max-batch-sec)でも頭打ちにならないようにする。
    # 既存値は不変(=過去 run と互換)、追加点は壁に達するまで走る。
    "CIM": [150, 300, 600, 1200, 2400, 4800, 9600, 19200],
    "CAC": [500, 1500, 4000, 12000, 35000, 80000, 200000],
    "SA":  [30000, 100000, 300000, 1000000, 3000000, 10000000, 30000000, 100000000],
    "SB":  [150, 400, 1000, 2500, 6000, 15000, 40000, 100000],
    "PT":  [30, 80, 200, 600, 1800, 5000],
    "GA":  [3, 8, 20, 50, 120, 300, 800],
}
