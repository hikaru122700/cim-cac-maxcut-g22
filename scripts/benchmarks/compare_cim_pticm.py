...
出力:
    results/<今日>/v{N}_compare_cim_pticm_<graph>_hist.png
    results/<今日>/v{N}_compare_cim_pticm_<graph>_running_best.png
    results/<今日>/v{N}_compare_cim_pticm_<graph>_bar.png
    results/<今日>/v{N}_compare_cim_pticm_<graph>_cuts.npz
    results/<今日>/v{N}_compare_cim_pticm_<graph>_summary.json
"""
